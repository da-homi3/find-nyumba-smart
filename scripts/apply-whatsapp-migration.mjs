/**
 * Apply supabase/migrations/20260611120100_whatsapp.sql via Supabase Management API.
...
const sqlPath = join(root, "supabase", "migrations", "20260611120100_whatsapp.sql");
