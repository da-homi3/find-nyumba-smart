/**
 * Apply supabase/migrations/20260611130000_whatsapp.sql via Supabase Management API.
...
const sqlPath = join(root, "supabase", "migrations", "20260611130000_whatsapp.sql");
