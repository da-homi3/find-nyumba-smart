/**
 * Re-assert properties contact PII column grants (anon/authenticated cannot SELECT contact_*).
 * Usage: npm run db:migrate:contact-grants
 */
...
async function main() {
  ...
  console.log("Applying contact column grants reassert…");
