/**
 * Apply supabase/migrations/20260702130000_performance_indexes.sql via Supabase Management API.
...
const sqlPath = join(root, "supabase", "migrations", "20260702130000_performance_indexes.sql");
