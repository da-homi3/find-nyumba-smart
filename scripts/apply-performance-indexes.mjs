/**
 * Apply supabase/migrations/20260628130000_performance_indexes.sql via Supabase Management API.
...
const sqlPath = join(root, "supabase", "migrations", "20260628130000_performance_indexes.sql");
...
try {
  ...
  console.log("Performance indexes migration applied successfully.");
