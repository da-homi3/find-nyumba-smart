/**
 * Apply properties search_vector FTS column + GIN index.
 * Usage: npm run db:migrate:search-vector
 */
...
const MIGRATION_SQL = readFileSync(
  join(root, "supabase", "migrations", "20260904160000_properties_search_vector.sql"),
  "utf8",
);
...
async function main() {
  ...
  console.log("Applying properties search_vector migration…");
