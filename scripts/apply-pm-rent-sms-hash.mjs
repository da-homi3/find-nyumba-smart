/**
 * Apply SMS content-hash unique index for rent paste fraud prevention.
 * Usage: node scripts/apply-pm-rent-sms-hash.mjs
 */
...
const MIGRATION = "20260811180000_pm_rent_sms_hash_dedupe.sql";
