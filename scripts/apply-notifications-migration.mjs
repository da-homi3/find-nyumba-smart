/**
 * Apply notifications inbox + preferences schema.
 * Usage: node scripts/apply-notifications-migration.mjs
 */
...
const MIGRATION_SQL = readFileSync(
  join(root, "supabase", "migrations", "20260725120000_notifications.sql"),
  "utf8",
);
...
async function main() {
  ...
  console.log("✓ notifications + notification_preferences ready.");
}
