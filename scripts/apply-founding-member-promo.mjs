#!/usr/bin/env node
/**
 * Apply founding member promo migration to Supabase via Management API.
...
const sqlPath = join(root, "supabase", "migrations", "20260705200000_founding_member_promo.sql");
...
console.log("✓ Founding member promo migration applied");
