#!/usr/bin/env node
/**
 * Apply email system migration to Supabase via Management API.
...
const sqlPath = join(root, "supabase", "migrations", "20260628120000_email_system.sql");
...
console.log("✓ Email system migration applied");
