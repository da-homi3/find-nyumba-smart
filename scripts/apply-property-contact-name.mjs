/**
 * Apply contact_name + whatsapp_inquiries on properties.
 * Usage: npm run db:migrate:contact-name
 */
...
const MIGRATION_SQL = readFileSync(
  join(root, "supabase", "migrations", "20260715160000_property_contact_name_whatsapp.sql"),
  "utf8",
);
...
async function main() {
  ...
  console.log("Applying property contact_name / whatsapp_inquiries migration…");
  ...
  if (url && key) {
    ...
    if (probe.error) {
      ...
      console.log("✓ Columns reachable via Supabase client");
    }
  }
