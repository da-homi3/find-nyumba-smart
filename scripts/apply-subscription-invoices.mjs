...
const sql = readFileSync(
  join(root, "supabase", "migrations", "20260819120000_platform_subscription_invoices.sql"),
  "utf8",
);
...
if (!res.ok) {
  console.error(res.status, body.slice(0, 1200));
  process.exit(1);
}
console.log("✓ platform_subscription_invoices applied");
