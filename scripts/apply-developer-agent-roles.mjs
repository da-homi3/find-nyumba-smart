/**
 * Apply property_developer + agent roles and REAL_ESTATE_AGENT pilot type.
 * Usage: npm run db:migrate:developer-agent
 */
...
const MIGRATION_SQL = readFileSync(
  join(root, "supabase", "migrations", "20260917120000_developer_agent_roles.sql"),
  "utf8",
);
...
async function main() {
  ...
  console.log("Applying developer/agent roles migration…");
