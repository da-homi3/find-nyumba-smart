/**
 * Apply reputation + loyalty schema.
 * Usage: node scripts/apply-reputation-loyalty-migration.mjs
 */
...
const MIGRATION_SQL = readFileSync(
  join(root, "supabase", "migrations", "20260726120000_reputation_loyalty.sql"),
  "utf8",
);
...
async function main() {
  ...
  console.log("Applying reputation + loyalty migration…");
