/**
 * Apply platform_reviews table for site footer reviews.
 * Usage: npm run db:migrate:platform-reviews
 */
...
const MIGRATION_SQL = readFileSync(
  join(root, "supabase", "migrations", "20260904180000_platform_reviews.sql"),
  "utf8",
);
