...
Google Play requires **at least 2 phone screenshots** (max 8). Use a **1080×1920** or **1080×2340** phone (or Android Studio emulator).
...
- Use **9:00** time and **full signal** in emulator settings for clean shots
- Dark mode: NyumbaSearch defaults to dark — screenshots look consistent
...
2. Upload screenshots in narrative order (search → browse → detail → map)
3. Add optional **promo video** (YouTube URL) if you have a demo reel
