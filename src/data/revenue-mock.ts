...
export const SERVICE_CATEGORIES = [
  ...
  { id: "water_services", label: "Water & borehole services" },
  { id: "generators", label: "Generators & backup power" },
  { id: "moving_supplies", label: "Moving supplies" },
  { id: "ac_repair", label: "AC & refrigeration" },
