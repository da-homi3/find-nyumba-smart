...
export const TENANT_SCORE_RULES: TenantScoreRule[] = [
  {
    id: "phone",
    name: "Phone verified",
    description: "Approved phone verification",
    points: 10,
    category: "verified",
  ...
  },
  {
    id: "email",
    name: "Email verified",
    description: "Confirmed email on the account",
    points: 10,
    category: "verified",
    tenantVisibility: true,
    enabled: true,
  },
  {
    ...
    description: "Approved identity verification",
    points: 20,
    category: "verified",
    tenantVisibility: true,
    enabled: true,
  },
  {
    ...
    description: "Approved employment verification",
    points: 15,
    category: "verified",
    tenantVisibility: true,
    enabled: true,
  },
  {
    ...
    description: "Approved income verification where offered",
    points: 15,
    category: "verified",
    tenantVisibility: true,
    enabled: true,
  },
  {
    ...
    description: "Previous tenancy notes provided",
    points: 10,
    category: "complete",
    tenantVisibility: true,
    enabled: true,
  },
  {
    ...
    description: "At least one preferred area",
    points: 5,
    category: "complete",
    tenantVisibility: true,
    enabled: true,
  },
  {
    ...
    description: "Budget range saved",
    points: 5,
    category: "complete",
    tenantVisibility: true,
    enabled: true,
  },
  {
    id: "move_in",
    name: "Move-in date",
    description: "Target move-in date saved",
    points: 5,
    category: "complete",
    tenantVisibility: true,
    enabled: true,
  },
  {
    ...
    description: "Name and phone on profile",
    points: 5,
    category: "complete",
    tenantVisibility: true,
    enabled: true,
