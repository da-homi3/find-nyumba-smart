...
<div class="wrapper">
  <div class="header"><div style="display:inline-block;background:#ffffff;padding:6px 12px;border-radius:10px;"><img class="logo-img" src="${logoUrl}" alt="NyumbaSearch" width="220" height="44" /></div></div>
