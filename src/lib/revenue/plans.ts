...
export const LANDLORD_PLANS: PlanCardDef[] = [
  {
    ...
    priceKes: 0,
    period: "/ month",
    desc: "Dashboard access after approval. Listing requires a paid plan.",
    features: [
      "No public listings until you subscribe",
      "Basic analytics (views only)",
      "Manual verification (Level 1)",
      "Standard search placement after you upgrade",
    ],
    cta: "Subscribe to list",
