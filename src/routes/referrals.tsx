...
function ReferralDashboard() {
  ...
  const shareText =
    "Join me on NyumbaSearch — find your next home or manage your properties: " + referralUrl;
    ...
    <>
      ...
      <div className="mx-auto max-w-2xl px-4 py-10">
        ...
        <p className="mb-6 text-sm text-white/50">
          Share your referral link. When they sign up and take their first real action, you both get
          rewarded.
        </p>
