...
function Page() {
  ...
  const vacancyMutation = useMutation({
    ...
    onSuccess: (_, vars) => {
      ...
      qc.invalidateQueries({ queryKey: ["agent-properties"] });
    },
  ...
  return (
    <div className="px-6 py-8 lg:px-10">
      <div className="flex items-end justify-between gap-4">
        <div>
          <h1 className="font-display text-3xl font-semibold">Agent listings</h1>
      ...
      {isLoading ? (
        ...
        <div className="mt-10 rounded-2xl border-2 border-dashed bg-card p-12 text-center">
          ...
          <Link to="/agent/properties/new" className="mt-4 inline-block text-sm font-semibold text-primary">
