...
const QUICK = [
  ...
  { label: "Compare saved", message: "Compare my saved listings", authOnly: true },

  {
    label: "Best neighborhoods",
    message: "Which Nairobi neighborhoods should I consider?",
    authOnly: false,
  },

  {
    label: "Scam check",
    message: "What are common rental scam red flags in Nairobi?",
    authOnly: false,
  },
];
