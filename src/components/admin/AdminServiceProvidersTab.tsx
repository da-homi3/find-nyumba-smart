    ...
    <div className="space-y-4">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <p className="text-sm text-muted-foreground">
          Approve waitlisted applications or upload a directory listing yourself.
        </p>
        <Link
      ...
      <AdminAsyncPanel
        ...
        emptyContent={
          <div className="rounded-2xl border border-dashed p-12 text-center text-sm text-muted-foreground">
            ...
            <div className="mt-4">
              <Link to="/admin/providers/new" className="text-primary hover:underline">
                Upload a provider to the directory
              </Link>
            </div>
          </div>
        }
