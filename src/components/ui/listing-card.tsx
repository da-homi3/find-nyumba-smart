...
const cardStyles = cva('rounded-lg overflow-hidden shadow-lg bg-white dark:bg-gray-800 transition-transform transform hover:scale-[1.02] hover:shadow-xl', {
  variants: {},
  defaultVariants: {}
});
  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        ...
        <p className="mt-2 text-primary-600 dark:text-primary-400 font-bold">${listing.price.toLocaleString()}</p>
      </div>
    </Link>
  );
}
